...
def bulk_modulus_fourth(rho, params):
    """
...
def Density(pressure, params):
    func = lambda x: birch_murnaghan_fourth(x , params) - pressure
    
    try:
        sol = bracket(func,0.1* params['rho_0'],4.5 * params['rho_0'])
...
def birch_murnaghan_fourth(rho, params):
    """
...
class BM4D(eos.EquationOfState):
    ...
    def pressure(self, temperature, rho, params):
        return birch_murnaghan_fourth(rho, params)
    ...
    def validate_parameters(self, params):
        ...
        if params['rho_0'] < 1. or params['rho_0'] > 1.e4:
