...
def find_Planet_mass(mass_planet, core_mass_frac, structure_params, compositional_params, grids, Core_wt_per, layers, Dry, Magma):
    """
    ...
    Planet = planet.compress_mass(*[Planet, grids, Core_wt_per, structure_params, layers, Dry, Magma])
